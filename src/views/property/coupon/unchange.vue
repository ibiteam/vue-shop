    ...
    <div class="coupon-unchange-container" v-cloak>
        ...
        <div class="coupon-dis">
            <div style="width:7.5rem;height:50px;">
                <div style="position:fixed;z-index:100;width:7.5rem;height:50px;" class="s_flex jc_ct bg_f2">
                    ...
                    <div class="coupon-list">
                        <div class="" v-for="(item, index) of couponList" :key="index">
                            <div class="coupon-list-item" :class="{ disable: activeIndex != 0 }">
                                <div class="coupon-list-info s_flex">
                                    <div class="coupon-item-le flex_align_center s_flex">
                                        <div class="fs32 integer fw_b" :class="{co_999: activeIndex != 0, co_666: activeIndex == 0 }">{{item.money &&
                                        item.money.toString().split('.')[0]}}
                                            <p class="fs14 price fw_b" :class="{co_999: activeIndex != 0, co_666: activeIndex == 0 }">￥</p>
                                        </div>
                                        <div class="fs14 MT10 fw_b" :class="{co_999: activeIndex != 0, co_666: activeIndex == 0 }"
                                             v-if="item.money && item.money.toString().split('.')[1]">.{{item.money &&
                                        item.money.toString().split('.')[1]}}
                                        </div>
                                    </div>
                                    <div class="coupon-item-cen">
                                        <h1 class="s_flex"><label class="elli_2" :class="{co_999: activeIndex != 0, co_333: activeIndex == 0 }">{{item.name}}</label></h1>
                                ...
                                <div class="coupon-desc flex_1" v-if="item.limit_shop_info != '' || item.limit_info != '' || (item.style_type == 3 && item.desc_show != '')">
                                    <div class="desc-p elli_2">
